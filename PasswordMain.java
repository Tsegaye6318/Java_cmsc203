...
public class PasswordMain extends BorderPane
{
	...
	public PasswordMain()
	{
		...
		VBox.setMargin(subpanel1a, new Insets(40,40,40,40));
		VBox.setMargin(subpanel1b, new Insets(40,40,40,40));
		...
		HBox.setMargin(checkPwdButton, new Insets(40,40,40,40));
		HBox.setMargin(checkPwdsInFileButton, new Insets(40,40,40,40));
		HBox.setMargin(exitButton, new Insets(40,40,40,40));
